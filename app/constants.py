...
SIZE.DISCORD_FRAME = Size(61.9 + 150,47)
SIZE.DISCORD_BUTTON = Size(61.9, 47)
...
SIZE.LOGS_ENTRY = Size(SIZE.LOGS_TEXTBOX.w * 0.825 - FRAME_GAP,
                       SIZE.LOGS_PANEL.h - (SIZE.LOGS_TEXTBOX.h + SIZE.LOGS_TOP_BAR.h) - FRAME_GAP * 4)
...
OFFSET.SHARD_STATUS_CIRCLE = Pos(OFFSET.SHARD_STATUS_MSG.x - SMALL_GAP * 0.75,
                                 SIZE.FRAME.h / 2 + SIZE.SHARD_STATUS_CIRCLE.h / 8)
...
OFFSET.LOGS_SHOW_END_BUTTON = Pos(SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_SHOW_END_BUTTON.w - FRAME_GAP * 2,
                                  SIZE.LOGS_TEXTBOX.h - SIZE.LOGS_SHOW_END_BUTTON.w - FRAME_GAP)
...
POS.CLUSTER_STATS = Pos(POS.CLUSTER_NAME.x + LARGE_GAP * 3.3,
                        POS.CLUSTER_NAME.y + (FONT_SIZE.CLUSTER_NAME - FONT_SIZE.CLUSTER_STATS))
POS.SHARD_GROUP = Pos(WINDOW_MARGIN, POS.CLUSTER_NAME.y + SMALL_GAP * 0.85)
POS.LAUNCH_BUTTON = Pos(WINDOW_WIDTH - WINDOW_MARGIN - SIZE.LAUNCH_BUTTON.w, POS.SHARD_GROUP.y + SIZE.SHARD_GROUP.h + (
        POS.SHARD_GROUP.y - POS.TOKEN_ENTRY.y - SIZE.TOKEN_ENTRY.h - SMALL_GAP / 2))
...
POS.DISCORD_BUTTON = Pos(POS.RESET_BUTTON.x * 0.15, POS.RESET_BUTTON.y)
